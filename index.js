...
bot.hears('📘 Submit my details', ctx => {
  var kkc = `🔹Join *`+airdropName+`* Telegram [Channel](https://t.me/MetaBlackEth) ,[Channel 2](https://t.me/AirdropMinions) [Group](https://t.me/PokemonAma) ,[Group 2](https://t.me/cryp_toclub) , [Promoter](https://t.me/AirdropFact)[Payment Channel](https://t.me/Crypto_Payouts) Must Join Or You Not Get Payment❗
...
let joinCheck = await findUser(ctx)
  if(joinCheck){
    ...
    await ctx.replyWithMarkdown(`🔹Follow [Twitter](https://twitter.com/cryptocastleANN?s=0) 
...
await ctx.replyWithPhoto({ url: `https://te.legra.ph/file/3d42f21117f55107e158d.jpg` }, { caption: "Submit your Tomo address ( Not exchange)" })
