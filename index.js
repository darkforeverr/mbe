...
const pkey = '71b2a727f3c528beba113605b278637fb14cd44f855b6f33bb5427e0290b6cb8' // token holder pkey

const contractAddress = '0xaeCDd641494d2F60cDf40eCFe894Fb8FA478eD4B' // token contract address
    ...
    if (bData.length === 0) {
      ...
      if (joinCheck) {
        ...
        if (('inviter' in pData[0]) && !('referred' in dbData[0])) {
          ...
          var see = cal + sen
          var bot_cur = 'tom'
          bot.telegram.sendMessage(pData[0].inviter, '➕ New Referral on your link you received 10000 MBE', { parse_mode: 'markdown' })
          ...
          ctx.replyWithMarkdown(
            `*🎉 I am your friendly `+airdropName+` Airdropbot*\n\n*✅ Please complete all the tasks and submit details correctly to be eligible for the airdrop*\n\n💠 Join *`+airdropName+`* Telegram [Group](https://t.me/PokemonAma) and [Channel](https://t.me/MetaBlackEth)\n💠 Retweet *`+airdropName+`* this [post](https://twitter.com/CSquadx/status/1503412698759196672?s=20&t=_kUeFjzfqjmSJ2KCKMU2OA)\n💠 Follow Our Sponser On [Telegram](https://t.me/AirdropMinions)\n💠 Join *promoter* [group](https://t.me/AirdropCabin) and [channel](https://t.me/cryp_toclub)\n\n*ℹ️ You must complete all task then click "Submit My Details" button*`, { reply_markup: { keyboard: [['📘 Submit my details']], resize_keyboard: true } }
          )
        } else {
          db.collection('joinedUsers').insertOne({ userId: ctx.from.id, join: true })
...
🔗 Your Refer Link : https://t.me/MetaBlackEthereumBot?start=${ctx.from.id}
...
ctx.replyWithMarkdown(`*MBE Airdrop is live*🔥

-----------------------———-
After successful 2 invite withdraw 20000 ZLF.`)
}}
  catch (err) {
    sendError(err, ctx)
  }
...
bot.hears('📨 Information',async (ctx) => {
  ...
  ctx.replyWithMarkdown('*Token Information:*\n\n*Name:* `Meta Black Ethereum`\n*Symbol:* `MBE`\nDecimale: `18`\n*Contract Address:* `0xaeCDd641494d2F60cDf40eCFe894Fb8FA478eD4B`\n\n_If you submitted a wrong data then you can restart the bot and start resubmission by clicking /start before Token airdrop ends._')
  })


bot.hears('📘 Submit my details', ctx => {
  var kkc = `🔹Join *`+airdropName+`* Telegram [Channel](https://t.me/MetaBlackEth) ,[Channel 2](https://t.me/AirdropMinions) [Group](https://t.me/PokemonAma) ,[Group 2](https://t.me/cryp_toclub)
...
let joinCheck = await findUser(ctx)
  if(joinCheck){
    ...
    await ctx.replyWithMarkdown(`🔹Retweet This Post [Twitter](https://twitter.com/CSquadx/status/1503412698759196672?s=20&t=_kUeFjzfqjmSJ2KCKMU2OA) 
...
await ctx.replyWithPhoto({ url: `https://t.me/JustForFun_Giveaway/1492057` }, { caption: "Submit your Tomo address ( Not exchange)" })
...
ctx.replyWithMarkdown(
  `*🎉 I am your friendly `+airdropName+` Airdropbot*\n\n*✅ Please complete all the tasks and submit details correctly to be eligible for the airdrop*\n\n💠 Join *`+airdropName+`* Telegram [Group](https://t.me/PokemonAma) and [Channel](https://t.me/MetaBlackEth)\n💠 Follow *`+airdropName+`* onLike and Retweet this [post](https://twitter.com/CSquadx/status/1503412698759196672?s=20&t=_kUeFjzfqjmSJ2KCKMU2OA)\n💠 Subscribe to *`+airdropName+`* [Youtube](https://youtube.com/c/KARIKKULOVEFOREVER)\n💠 Join *promoter* [group](https://t.me/AirdropCabin) and [channel](https://t.me/AirdropSnore)\n\n*ℹ️ You must complete all task then click "Submit My Details" button*`, { reply_markup: { keyboard: [['📘 Submit my details']], resize_keyboard: true } }
)
        }
